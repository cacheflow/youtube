...
/***/ function(module, exports, __webpack_require__) {
	...
	var VideoContainer = __webpack_require__(159);

	ReactDOM.render(React.createElement(VideoContainer, null), document.getElementById('video'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var youtube = __webpack_require__(160);
	var React = __webpack_require__(1);
	var ReactDOM = __webpack_require__(158);
	var update = __webpack_require__(167);
	var Video = __webpack_require__(169);
	...
	var VideoContainer = React.createClass({
	  ...
	  getVideos: function getVideos() {
	    ...
	    youtube.get(this.state.selectedVideo).then(function (response) {
	  ...
	  setVideoState: function setVideoState(vidTitle, vidId) {
	  ...
	  showLoadingMessage: function showLoadingMessage() {
	    if (this.state.loading) {
	      return React.createElement('h1', null, ' Loading your videos ');
	    } else {
	  ...
	  render: function render() {
	    ...
	    var videos = this.state.videos.map(function (data, index) {
	      return React.createElement('div', { className: 'videoBox' }, React.createElement(Video, {
	        title: data.title,
	        key: data.title + index,
	        vidId: data.vidId,
	        iFrameLoaded: _this.loadIframe
	      }));
	    });
	    return React.createElement('div', null, React.createElement('div', { className: 'form-group' }, React.createElement('label', null, 'Select Artist'), React.createElement('select', { className: 'form-control',
	      ref: 'selectedArtist',
	      onChange: this.handleChange }, React.createElement('option', { value: 'Stevie Wonder' }, ' Stevie Wonder '), React.createElement('option', { value: 'Frank Sinatra' }, ' Frank Sinatra '), React.createElement('option', { value: 'Elton John' }, ' Elton John '), React.createElement('option', { value: 'Louis Armstrong' }, ' Louis Armstrong '))), this.showLoadingMessage, React.createElement('div', { className: 'container' }, videos));
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var youtube = {
	  get: function get(search) {
	    ...
	    var url = 'https://www.googleapis.com/youtube/v3/search?part=id%2Csnippet&maxResults=20&type=video&videoEmbeddable=true&q=' + search + '&key=AIzaSyBGcSDEjbCCN98NzuZm7wEJaNfa2A6b5K4';
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(4), (function() { return this; }()), __webpack_require__(162)(module)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Video = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement('div', { ref: 'youtube' }, React.createElement('iframe', { ref: 'iframeVideo', src: this.props.vidId, frameBorder: '0', allowFullScreen: true }));
	  }
	});
